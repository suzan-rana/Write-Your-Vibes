    ...
    <footer className="bg-transparent mt-20 pb-20">
      <div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:pt-20">
        ...
        <div className="mt-5 grid gap-y-2 min-h-[20rem] sm:mt-12 sm:flex sm:items-center sm:justify-between sm:gap-y-0">
          ...
          <div>
            <a
              className="inline-flex h-10 w-10 items-center justify-center gap-x-3.5 rounded-md text-center text-gray-200 transition hover:bg-white/[.1] focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 focus:ring-offset-gray-900"
              href="#"
            >
              <svg
                className="h-4 w-4"
            ...
            <a
              className="inline-flex h-10 w-10 items-center justify-center gap-x-3.5 rounded-md text-center text-gray-200 transition hover:bg-white/[.1] focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 focus:ring-offset-gray-900"
              href="#"
            >
              <svg
                className="h-4 w-4"
